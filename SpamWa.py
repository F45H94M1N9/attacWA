...
def Banner():
 ...
 |____/| .__/ \__,_|_| |_| |_|    \_/\_/ \__,_|
       |_|                                     
                   '''+W+'Creator : ./F45H94M1N9\n\t\t   YT : Fash Gaming Indonesia')
...
def Spam():
	os.system('clear')
	print(C+'Subscribe YT'+W+' Gua Dlu Cuk !'+C+' :V')
	sleep(1.5)
	os.system('termux-open-url https://www.youtube.com/channel/UCF61OnE5_ZG3k9LGg-s0e2A?sub_confirmation=1')
	os.system('clear')
	sleep(1.3)
	Banner()
	print
